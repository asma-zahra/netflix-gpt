    ...
    if (!isSignInForm) {
      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          console.log(user);
          // Sign successful then update logged in user name photo by calling updateProfile API
          updateProfile(user, {
            displayName: name.current.value,
            photoURL: USER_AVATAR,
          })
            .then(() => {
              //once updated profile then dispatch action and will update user (currentUser)
